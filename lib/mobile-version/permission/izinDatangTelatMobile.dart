...
class izinDatangTelatMobile extends StatefulWidget {
  const izinDatangTelatMobile({super.key});

  @override
  State<izinDatangTelatMobile> createState() => _izinDatangTelatMobileState();
}

class _izinDatangTelatMobileState extends State<izinDatangTelatMobile> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(child: Text('Formulir Izin Datang Telat', style: TextStyle(
                            fontSize: 14.sp,
