...
class viewLemburMobile extends StatefulWidget {
  final String permissionId;
  const viewLemburMobile({super.key, required this.permissionId});

  @override
  State<viewLemburMobile> createState() => _viewLemburMobileState();
}

class _viewLemburMobileState extends State<viewLemburMobile> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(child: Text('Formulir Izin Lembur', style: TextStyle(
                          fontSize: 14.sp,
