...
class viewSakitMobile extends StatefulWidget {
  ...
  const viewSakitMobile({super.key, required this.permissionId});

  @override
  State<viewSakitMobile> createState() => _viewSakitMobileState();
}

class _viewSakitMobileState extends State<viewSakitMobile> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(child: Text('Formulir Izin Sakit', style: TextStyle(
                          fontSize: 14.sp,
