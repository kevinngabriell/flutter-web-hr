...
class viewPulangAwalMobile extends StatefulWidget {
  final String permissionId;
  const viewPulangAwalMobile({super.key, required this.permissionId});

  @override
  State<viewPulangAwalMobile> createState() => _viewPulangAwalMobileState();
}

class _viewPulangAwalMobileState extends State<viewPulangAwalMobile> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(child: Text('Formulir Pengajuan Izin', style: TextStyle(
                          fontSize: 14.sp,
