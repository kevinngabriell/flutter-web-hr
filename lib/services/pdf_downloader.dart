...
Future<Uint8List> generatePDFPinjamanKaryawan() async {
  final pdf = pw.Document();
  final completer = Completer<Uint8List>();
...
Future<void> generateAndDisplayPDFPinjamanKaryawan(loanId, employee_name, position, loan_amount, loan_reason, loan_topay, spv_name, spv_dt, hr_name, hr_dt, insert_dt) async {
 
    // Generate PDF
    final Uint8List pdfBytes = await generatePDFPinjamanKaryawan();
