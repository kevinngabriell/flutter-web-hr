  ...
  Future<void> fetchInventory() async{
    ...
    try{  
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          allInventory = List<Map<String, dynamic>>.from(data['Data']);
        });
      } else {
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Nama Item', style: TextStyle(fontSize: 4.sp, fontWeight: FontWeight.w700)),
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index){
                                ...
                                return Padding(
                                  ...
                                  child: Card(
                                    child: ListTile(
                                      title: Text(itemSearch['inventory_name'], style: TextStyle(fontSize: 4.sp, fontWeight: FontWeight.w700)),
                                      subtitle: Text(itemSearch['inventory_id'], style: TextStyle(fontSize: 3.sp, fontWeight: FontWeight.w400)),
                                      trailing: Container(
                                        ...
                                        child: Text(itemSearch['status_name'], textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 3.sp),),
                                      ),
                                      onTap: () {
