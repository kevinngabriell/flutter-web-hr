                              ...
                              child: Card(
                                child: Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Text('Pengaturan Perusahaan', style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w700,)),
                              ...
                              child: Card(
                                child: Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Text('Panduan Pengguna', style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w700,)),
                                      SizedBox(height: 10.h,),
