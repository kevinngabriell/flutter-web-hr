                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index){
                              return GestureDetector(
                                ...
                                child: Card(
                                  child: ListTile(
                                    title: Text(businessTripHRDApproval[index]['employee_name'], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700),),
                                    subtitle: Text('${businessTripHRDApproval[index]['nama_kota']} (${businessTripHRDApproval[index]['duration_name']})', style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w400),),
                                    trailing: Text(businessTripHRDApproval[index]['status_name'], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700),),
                                  ),
                                ),
                              );
                            }
