                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index){
                              return GestureDetector(
                                ...
                                child: Card(
                                  child: ListTile(
                                    title: Text(LPDApproval[index]['employee_name'], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700),),
                                    subtitle: Text('${LPDApproval[index]['name']} (${LPDApproval[index]['project_name']})', style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w400),),
                                    trailing: Text(LPDApproval[index]['status_name'], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700),),
                                  ),
                                ),
                              );
                            }
