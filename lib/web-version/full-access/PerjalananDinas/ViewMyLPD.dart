...
class ViewMyLPD extends StatefulWidget {
  const ViewMyLPD({super.key});

  @override
  State<ViewMyLPD> createState() => _ViewMyLPDState();
}

class _ViewMyLPDState extends State<ViewMyLPD> {
  String? leaveoptions;
  String companyName = '';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Laporan Perjalanan Dinas Saya',
      home: SafeArea(
        child: Scaffold(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index){
                              return GestureDetector(
                                ...
                                child: Card(
                                  child: ListTile(
                                    title: Text(myLPD[index]['employee_name'], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700),),
                                    subtitle: Text('${myLPD[index]['name']} (${myLPD[index]['project_name']})', style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w400),),
                                    trailing: Text(myLPD[index]['status_name'], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700),),
                                  ),
                                ),
                              );
                            }
