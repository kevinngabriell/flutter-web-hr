...
class TrainingIndex extends StatefulWidget {
  const TrainingIndex({super.key});

  @override
  State<TrainingIndex> createState() => _TrainingIndexState();
}

class _TrainingIndexState extends State<TrainingIndex> {
  String companyName = '';
