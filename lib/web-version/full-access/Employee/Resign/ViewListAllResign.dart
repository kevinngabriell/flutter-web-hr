...
class viewListAllResign extends StatefulWidget {
  const viewListAllResign({super.key});

  @override
  State<viewListAllResign> createState() => _viewListAllResignState();
}

class _viewListAllResignState extends State<viewListAllResign> {
  String? leaveoptions;
  String companyName = '';
  ...
  Future<void> fetchKasbons() async {
    try {
      final response = await http.get(Uri.parse(
          'https://kinglabindonesia.com/hr-systems-api/hr-system-data-v.1.2/resign/getresign.php?action=2'));
