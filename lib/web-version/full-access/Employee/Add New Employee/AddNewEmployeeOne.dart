...
class AddNewEmployeeFirst extends StatefulWidget {
  const AddNewEmployeeFirst({super.key});

  @override
  State<AddNewEmployeeFirst> createState() => _AddNewEmployeeFirstState();
}

class _AddNewEmployeeFirstState extends State<AddNewEmployeeFirst> {
                ...
                child: Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Center(child: Text('Pendataan Karyawan Baru', style: TextStyle(fontSize: 5.sp, fontWeight: FontWeight.w600,))),
                        SizedBox(height: 7.sp,),
                        Row(
                        ...
                        Row(
                          ...
                          children: [
                            ElevatedButton(
                              ...
                              child: const Text('Kumpul & Berikutnya')
                            )
                          ],
                        ),
                        SizedBox(height: 10.sp,),
