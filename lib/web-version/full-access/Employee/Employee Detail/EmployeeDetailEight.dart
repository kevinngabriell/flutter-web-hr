...
class EmployeeDetailEight extends StatefulWidget {
  ...
  @override
  State<EmployeeDetailEight> createState() => _EmployeeDetailEightState();
}

class _EmployeeDetailEightState extends State<EmployeeDetailEight> {
  String companyName = '';
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            child: const Text('Kembali ke Halaman Overview')
                          )
                        ],
                      )
                    ]
