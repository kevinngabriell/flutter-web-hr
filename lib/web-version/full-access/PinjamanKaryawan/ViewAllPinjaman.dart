                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index){
                              return GestureDetector(
                                ...
                                child: Card(
                                  child: ListTile(
                                    title: Text(LoanList[index]['employee_name'], style: TextStyle(fontSize: 5.sp, fontWeight: FontWeight.w700),),
                                    subtitle: Text(formatCurrency2(LoanList[index]['loan_amount']), style: TextStyle(fontSize: 4.sp, fontWeight: FontWeight.w400),),
                                    trailing: Text(LoanList[index]['status_name'], style: TextStyle(fontSize: 4.sp, fontWeight: FontWeight.w700),),
                                  ),
                                ),
                              );
                            }
