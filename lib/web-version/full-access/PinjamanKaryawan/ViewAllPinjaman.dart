...
class ViewAllPinjaman extends StatefulWidget {
  const ViewAllPinjaman({super.key});

  @override
  State<ViewAllPinjaman> createState() => _ViewAllPinjamanState();
}

class _ViewAllPinjamanState extends State<ViewAllPinjaman> {
  String? leaveoptions;
  String companyName = '';
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index){
                              return GestureDetector(
                                onTap: () {
                                  Get.to(PinjamanKaryawanDetail(pinjamanKaryawanID: LoanList[index]['loan_id'], jumlahPinjaman: LoanList[index]['loan_amount'], alasanPinjaman: LoanList[index]['loan_reason'], caraBayarPinjaman: LoanList[index]['loan_topay'], statusPinjaman: LoanList[index]['status_name'], sudahLunasPinjaman: LoanList[index]['is_paid'], tanggalPengajuan: LoanList[index]['insert_dt'], namaKaryawan: LoanList[index]['employee_name'], requestorID: LoanList[index]['insert_by'], jabatan: LoanList[index]['position_name'], departemen: LoanList[index]['department_name'],));
                                },
                                child: Card(
                                  child: ListTile(
                                    title: Text(LoanList[index]['employee_name'], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700),),
                                    subtitle: Text(formatCurrency2(LoanList[index]['loan_amount']), style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w400),),
                                    trailing: Text(LoanList[index]['status_name'], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700),),
                                  ),
                                ),
                              );
                            }
